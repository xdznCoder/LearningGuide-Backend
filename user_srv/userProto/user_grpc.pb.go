...
func (c *userClient) ChangePassword(ctx context.Context, in *ChangePasswordRequest, opts ...grpc.CallOption) (*Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Empty)
...
func (UnimplementedUserServer) ChangePassword(context.Context, *ChangePasswordRequest) (*Empty, error) {
